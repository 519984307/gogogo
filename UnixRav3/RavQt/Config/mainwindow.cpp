...
// 2021.10.15 by zhangdong
	if(m_pRightAddWidget->m_pAddWidget->m_eFireWall->isChecked()){
		m_pRightAddWidget->m_pAddWidget->m_pIpPort->m_PortName->m_Stringdata->InitAll();
		m_pRightAddWidget->m_pAddWidget->m_pIpBlackList->m_IpBlackName->m_Stringdata->setIpBlack();
		m_pRightAddWidget->m_pAddWidget->m_pIpWhiteList->m_IpWhiteName->m_Stringdata->setIpWhite();
		m_pRightAddWidget->m_pAddWidget->m_pIpPort->m_PortName->m_Stringdata->setPort();
		m_pRightAddWidget->m_pAddWidget->m_pIpPort->m_PortName->m_Stringdata->EnableAll();
	}
	else{
		m_pRightAddWidget->m_pAddWidget->m_pIpPort->m_PortName->m_Stringdata->DisableAll();
	}

//2021.10.25 by zhangdong
	//CommandBundle command;
	//int ret = 0;
	////command.mCommandID = RSSUDO_EXECUTE;
	//command.mCommandID = 200;
	//command.mStringValue = "iptables -F";

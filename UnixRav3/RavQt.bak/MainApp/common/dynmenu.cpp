...
DynMenu::DynMenu(bool isSecureMachine)
{
	...
	connect(this, SIGNAL(signal_setUpdateTitle(const QString &, bool)), this, SLOT(slot_setUpdateTitle(const QString &, bool)));
}
...
void DynMenu::setUpdateTitle(const QString &title, bool showed) {
	emit signal_setUpdateTitle(title, showed);
}

void DynMenu::slot_setUpdateTitle(const QString &title, bool showed) {

...
class CQActiveDialog : public QDialog
{
	Q_OBJECT
public:
	CQActiveDialog(QWidget * qbase);
	~CQActiveDialog();

	std::string & GetActiveInfo();


public slots:
	void OnSelectLicFile();
	void OnAccept();
...
private:
	...
	QLineEdit          * m_qserial;
	QLineEdit          * m_qlicense;
	QDialogButtonBox   * m_qbtnok, * m_qbtncancel, * m_qbtnopen;
